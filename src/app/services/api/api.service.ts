...
export class ApiService {
  ...
  modifyPlace(place_id, place_name, place_description, id_establishment) {
    return this.http.post<any>(environment.api_url + '/establishment/modify_place', { "place_id": place_id , "name": place_name, "description": place_description, "webUser": {"user_id": id_establishment} })
  }
}